...
public class VisitManager {
    ...
    /**
     * Creates a visit
     * @param plotId: plot id where the visit takes place
     * @return visit id
     */
    ...
    /**
     * Fetch the plot id where the visit takes place
     * @param visit_id: visit id
     * @return plot id
     */
        ...
        if(visitData != null) {
            ...
            for (String key : track.keySet()) {
                if (track.get(key) != null) {
                    String[] aux2 = track.get(key).split("/");
