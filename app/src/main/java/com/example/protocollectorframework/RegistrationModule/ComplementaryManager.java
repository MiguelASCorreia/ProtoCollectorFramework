...
public class ComplementaryManager {
     ...
     *
     * @param complementary_id: complementary identifier
    ...
    /**
     * Fetch complementary observations associated to a visit by visit identifier
     *
     ...
     *
     * @param complementary_id: complementary identifier
     * @return integer that identifierentifies the status.
     * 0 == not uploaded
     * 1 == uploaded
     * 2 == edited
     * -1  == error on upload
