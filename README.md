...
```
	INTERNET: explicits the need for internet connection.
	WIFI: explicits the need for internet connection via Wi-Fi.
	BLUETOOTH: explicits the need for bluetooth.
	GPS: explicits the need for GPS signal.
```
